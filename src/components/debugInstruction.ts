...
/**
 * Entrega instruções do Debug Tool sem derrubar a aplicação em runtime.
 * Mensagens com o prefixo interno são salvas pelo fallback do popup, em vez de
 * virar um erro fatal que deixa a tela em branco para o usuário final.
 */
