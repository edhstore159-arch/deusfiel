...
/**
 * Dispara o CustomEvent de depuração apenas para erros reais do app.
 * Instruções internas de desenvolvimento são dados de suporte e não podem
 * virar erro fatal, pois isso deixa a aplicação em tela branca.
 */
