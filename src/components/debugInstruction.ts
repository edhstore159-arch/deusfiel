...
/**
 * Só dispara o erro fatal quando existir um runtime nativo explícito para isso.
 * No preview/app normal, retorna false para salvar a instrução no backend sem
 * derrubar a interface com uma tela branca.
 */
