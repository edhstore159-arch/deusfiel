...
const DEFAULT_AGENT = {
  ...
  instructions: "Analise o caso seguindo o fluxo obrigatório: identificar temas → pesquisar legislação → jurisprudência real → separar fatos/direito → fundamentar → checklist → dispositivo. Nunca invente artigos ou jurisprudência.",
  avatar: "",
  active: true,
  createdAt: new Date().toISOString(),
};
