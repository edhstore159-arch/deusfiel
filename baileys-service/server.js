...
async function startSock() {
  ...
  sock = makeWASocket({
    ...
    // Preview env (sem disco persistente) tem latência alta para o app-state
    // sync. O default de 60s causa timeout no 'init queries' → stream errored
    ...
    // Para retransmissão de mensagens: retornamos undefined (Baileys aceita)
